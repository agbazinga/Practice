...
public class SlidingTabStrip extends LinearLayout {
    ...
    private final int DEFAULT_SELECTED_INDICATOR_COLOR;
    ...
    SlidingTabStrip(Context context, AttributeSet attrs) {
        ...
        DEFAULT_SELECTED_INDICATOR_COLOR = ContextCompat.getColor(context, android.R.color.white);
